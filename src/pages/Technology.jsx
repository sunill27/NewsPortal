...
const Technology = () => {
  ...
  const fetchTechnologyNews = async (category, page = 1, append = false) => {
    try {
      setLoading(true);
      const limit = 8;
      ...
      setTechnologyNews((prev) => (append ? [...prev, ...newItems] : newItems));
  ...
  useEffect(() => {
    fetchTechnologyNews("technology", 1);
  }, []);
  ...
  const handleLoadMore = (category) => {
    ...
    fetchTechnologyNews(category, nextPage, true);
  };
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
          ...
          {hasMore.technology && (
            <div className="col-span-full text-center mt-6">
              <button
                onClick={() => handleLoadMore("technology")}
