...
const Corporate = () => {
  ...
  const currentCategory = "corporate";
  ...
  const fetchCorporateNews = async (category, page = 1, append = false) => {
    try {
      setLoading(true);
      const limit = 8;
      ...
      setCorporateNews((prev) => (append ? [...prev, ...newItems] : newItems));
      ...
      setError("Failed to load corporate news");
    }
  };

  useEffect(() => {
    fetchCorporateNews("corporate", 1);
  }, []);
  ...
  const handleLoadMore = (category) => {
    ...
    fetchCorporateNews(category, nextPage, true);
  };
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
          ...
          {hasMore.corporate && (
            <div className="col-span-full text-center mt-6">
              <button
                onClick={() => handleLoadMore("corporate")}
